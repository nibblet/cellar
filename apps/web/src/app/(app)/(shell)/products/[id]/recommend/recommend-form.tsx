...
import type { ReleaseLabelSource } from "@/lib/tasting/release-label";
...
type RecommendFormProps = {
  ...
  leafLabels: string[];
  initial: { recommend: boolean; chips: string[]; note: string | null; release_label?: string | null } | null;
  eventId: string | null;
...
export function RecommendForm({
  ...
  return (
    <form action={action} className="flex flex-col gap-5">
      ...
      {releaseLabelSource ? (
        <input type="hidden" name="release_label_source" value={releaseLabelSource} />
      ) : null}
